...
"
          ...
          <div class="hidden-tablet">
            <div class="button-container">
              <a href="#" class="button-primary small w-button"
                >CONNECT WALLET</a
              >
            </div>
          </div>
        ...
        <div class="w-layout-grid hero-grid">
          ...
          >
            ...
            <p class="paragraph-large">
              <img style="width: 22px; height: 22px; margin-bottom:8px;" src="@/assets/smiling-face-with-heart-eyes_1f60d.webp"> No gas fees for minting or transfers
            </p>
            <p class="paragraph-large">
              <img style="width: 22px; height: 22px; margin-bottom:8px;" src="@/assets/smiling-face-with-heart-eyes_1f60d.webp"> Create, Buy, and Sell NFTs
            </p>
            <p class="paragraph-large">
              <img style="width: 22px; height: 22px; margin-bottom:8px;" src="@/assets/smiling-face-with-heart-eyes_1f60d.webp"> Earn $KSM and $UNQ for each NFT sale
            </p>

            <div class="mg-top-48px">
              <div class="button-container">
                <a
                  href="https://api.elasticemail.com/form?lid=_gqT8YCXDfz5r4kCOLecrw2"
        ...
        <div class="footer-top">
          ...
          <div>
            <ul role="list" class="list-social-media">
              ...
              <li class="list-item-social-media">
                <a href="https://www.instagram.com/luvnft"
                  ><i class="social-media-icon fab fa-instagram fa-lg"></i
                ></a>
              </li>
              <!-- <li class="list-item-social-media">
...
export default {
  ...
  methods: {
    ...
    onGalleryItemClick() {console.log('')}
  },
  data() {
    return {
      isModalActive: false,
