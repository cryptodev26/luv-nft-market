...
"
                        ...
                        >
                          ...
                          <div class="w-commerce-commercecartfooter cart-footer">
                            ...
                            <div>
                              ...
                              <div class="button-container full-width mg-top-16px">
                                <a
                          ...
                          <div class="mega-menu">
                            ...
                            <div class="mega-menu-column-1">
                              <a
                                ...
                                >HOME</a
                              ><a href="https://nfttemplate.webflow.io/store" class="mega-menu-link"
                                >Store</a
                              >
                              <a
                          ...
                          <div class="mega-menu">
                            ...
                            <div class="mega-menu-column-1">
                              ...
                              <a
                                ...
                                >Style Guide</a
                              >
                              <a href="https://nfttemplate.webflow.io/404" class="mega-menu-link"
                                >404 Not Found</a
                              ><a href="https://nfttemplate.webflow.io/401" class="mega-menu-link"
          ...
          <div class="split-content header-right">
            <div class="mobile-menu">
              <div class="menu-button w-nav-button" style="-webkit-user-select: text;" aria-label="menu" role="button" tabindex="0" aria-controls="w-nav-overlay-0" aria-haspopup="menu" aria-expanded="false"><div class="menu-button-icon-wrapper"><div class="menu-button-icon"><div class="menu-line-top"></div><div class="menu-line-middle"></div><div class="menu-line-bottom"></div></div></div></div>
...
"
      ...
      <div data-w-id="4eabff81-1a43-f11f-339b-2d46f64fc52a" class="section hero-home" style="display: none;">
      ...
      <div id="about" data-w-id="459cd8d6-6bd6-c406-d0f4-2fb0365f9af8" class="section shop-home" style="display:none;">
        ...
        <div class="container-default w-container">
          ...
          >
            <div class="card-crystal">
              <h3>NO GAS FEES</h3>
              <p class="paragraph-large">
                LUV NFT uses Polkadot/Kusma network which allows us to offer gas-free minting and trading. 
              </p>
            </div>
            <div class="card-crystal">
              <h3>GO DIGITAL</h3>
              <p class="paragraph-large">
              Turn your customers or fans to patrons by selling digital goods verified with blockchain technology.
              </p>
            </div>
            <div class="card-crystal">
              <h3>AUTHENTIC</h3>
              <p class="paragraph-large">
                Digitally sign your creation on LUV NFT permanently and verified through the blockchain.
              </p>
            </div>
            <div class="card-crystal">
              <h3>OWNERSHIP</h3>
              <p class="paragraph-large">
                Once you purchase your unique digital collectible, it's transferred and stored in your digital wallet.
              </p>
            </div>
          </div>
        </div>
      ...
      <div id="contact" data-w-id="7f1f1943-19a1-0d5c-f860-1d61242ddb06" class="section contact" style="display:none;">
        <div class="container-default w-container">
            ...
            >
              ...
              <div class="mg-top-40px">
                ...
                >
                  ...
                  <div class="underline-wrapper"><div class="underline"></div></div>
                </a>
              </div>
            </div>
            <div
                ...
                <div class="w-form">
                  ...
                  >
                    <div class="w-layout-grid grid-form">
                      ...
                      <div id="w-node-_976f08fa-4bd7-5cb4-b53d-2187f5f1194b-0634c740">
                        <textarea
            ...
            <div class="footer-top-left">
              ...
              <ul role="list" class="footer-nav">
                <li class="footer-nav-item">
                  <a href="/" aria-current="page" class="nav-link footer w--current"
                    >HOME</a
                  >
                </li>
                <li class="footer-nav-item">
                ...
                <li class="footer-nav-item">
                  <a href="https://luvnft.medium.com/" target="_blank"  class="nav-link footer">BLOG</a>
                </li>
                <li class="footer-nav-item">
